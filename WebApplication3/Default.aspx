...
<body onload="myFunction()" style="margin:0;">
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <div id="infocard" style="visibility: hidden; width: 0; height: 0;"><div class="image" style="position: relative">
            <a href="javascript:void(0)" onclick="closeNav()" style="position: absolute; top: 0; left: 0; color:black;">&#x2190;</a><img id="photo" style="width:100%; height:30%;" src="nopicture.jpg" /></div>
            <div id="contactinfo" style="margin: 0 auto; display: block;"><h1 id="name"></h1><h3 id="office"></h3><h3 id="position"></h3></div></div>
        <div id="searchContainer" style="height: 5%; border-width: 0;">
            ...
            <div class="myUL"><li><a href="#" style="background-color: dimgrey; border-width: 0;">People</a></li></div>
            <div class="myUL" id="nameContainer"></div>
            <div class="myUL"><li><a href="#" style="background-color: dimgrey; border-width: 0;">Rooms</a></li></div>
            <div class="myUL" id="roomContainer">
            </div>

            <div class="myUL"><li><a href="http://www.mapleleaffoods.com/contact-us/" style="background-color: dimgray; border-width: 0;">Feedback</a></li></div>
    ...
    <div id="container" style="position: relative;">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="-100px" y="0px" width="15px" viewBox="0 0 1920.9 1080.1" style="enable-background: new 0 0 1920.9 1080.1;" xml:space="preserve" id="svg-id">
            <style type="text/css">
            ...
            <g>
                ...
                <path xmlns="http://www.w3.org/2000/svg" class="st11" d="M1224.9,248.8c-79.9-21.6-169.4-21.1-245,15.6c-5,2.4-10,4.9-14.6,8c1,0.1,2,0.3,3,0.4     c-26.8-26-53.5-52-80.3-77.9c-3.9-3.8-7.7-7.5-11.6-11.3c-1-0.9-2.6-1-3.5,0c-15,15.5-30,31-44.9,46.4     c-36,37.2-71.9,74.3-107.9,111.5c-43.3,44.8-86.6,89.5-129.9,134.3c-37.5,38.7-74.9,77.4-112.4,116.1     c-12.4,12.9-24.9,25.7-37.3,38.6c-5.7,5.9-12.6,11.6-17.6,18.2c-0.2,0.3-0.5,0.5-0.8,0.8c-0.9,1-1,2.6,0,3.5     c36.4,35.3,72.8,70.7,109.3,106c58,56.3,116.1,112.6,174.1,168.9c13.3,12.9,26.6,25.8,39.8,38.7c1,0.9,2.6,1,3.5,0     c28.3-29.4,56.7-58.7,85-88.1c45.2-46.8,90.3-93.6,135.5-140.4c10.4-10.8,20.8-21.5,31.2-32.3c-1.2,0-2.4,0-3.5,0     c8.3,8,16.4,16.2,24.8,24.1c3,2.9,5.1,2.3,9.1,2.2c20.4-0.5,40.9-0.9,61.3-1.4c54.7-1.2,109.4-2.5,164.1-3.7     c4.7-0.1,11,0.9,15.6-0.4c3.4-0.9,6.2-5.2,8.6-7.7c4.5-4.6,9-9.2,13.5-13.9c-1.2,0-2.4,0-3.5,0c30.3,29.7,60.7,59.4,91,89.1     c48.3,47.3,96.6,94.6,144.9,141.8c11,10.8,22.1,21.6,33.1,32.4c1,0.9,2.6,1,3.5,0c32.4-33.4,64.8-66.8,97.3-100.2     c51.7-53.3,103.4-106.6,155.2-159.9c11.9-12.3,23.8-24.6,35.8-36.9c0.9-1,1-2.6,0-3.5c-17.6-17-35.2-34.1-52.9-51.1     c-42.3-40.9-84.6-81.9-126.9-122.8c-51.2-49.6-102.4-99.1-153.6-148.7c-44.3-42.9-88.6-85.7-132.9-128.6     c-14.6-14.1-29.2-28.3-43.8-42.4c